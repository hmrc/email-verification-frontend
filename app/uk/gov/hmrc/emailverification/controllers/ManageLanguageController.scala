...
@Singleton
class ManageLanguageController @Inject()(config: FrontendAppConfig,
                                         languageUtils: LanguageUtils)(implicit val messagesApi: MessagesApi)
  extends LanguageController(config.runModeConfiguration, languageUtils) {
